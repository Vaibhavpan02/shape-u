...
exports.getProgress = function (userId, courseId) { return __awaiter(void 0, void 0, Promise, function () {
    var publishedChapters, publishedChapterIds, validCompletedChaptersCount, progressPercentage, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                validCompletedChaptersCount = _a.sent();
                progressPercentage = (validCompletedChaptersCount / publishedChapterIds.length) * 100;
                // Ensure the result is a number
                return [2 /*return*/, progressPercentage];
            case 3:
                error_1 = _a.sent();
                console.error("[GET_PROGRESS]", error_1);
                return [2 /*return*/, 0];
